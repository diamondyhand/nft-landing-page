  ...
  return (
    ...
    <ConfettiComponent  /> </Suspense>
      ...
      <Container>
        ...
        <MemberComponent img={img2}  name="AZSA" position="founder" />
        <MemberComponent img={img3}  name="MONKEY KING" position="Director" />
        <MemberComponent img={img4}  name="SAUI" position="manager" />
        ...
        <MemberComponent img={img8}  name="Daniel" position="Blockchain Developer" />
